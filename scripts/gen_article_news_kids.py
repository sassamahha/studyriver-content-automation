...
questions_block_example:
    | 質問例 | ねらい |
    |-------|-------|
    | ○○がもっと身近になったら、あなたはどんなルールを作りたい？ | 行動の選択・ルールメイキング |
    | ○○を知らないお友達に伝えるとしたら、どんな言葉や絵を使う？ | 協働的学び・コミュニケーション |
    | ○○によって困っている人がいたら、地域でどんな助け方ができるかな？ | 社会参加の考察・共感力 |
    | 未来の学校では○○をどう使うと楽しく学べると思う？ | 想像力・学習デザイン |
    | ○○がなくなった世界を想像して、毎日の暮らしはどう変わる？ | 問題解決力・逆転発想 |
    | ○○について友達と意見が分かれたら、話し合いを進めるために何ができる？ | 協働的学び・合意形成 |
    | ○○を安心して使うために、家族でどんな約束を決めたい？ | 行動の選択・デジタルシチズンシップ |
    | ○○で得た情報が本当か確かめるとしたら、どんな方法がある？ | メディアリテラシー・批判的思考 |
    | ○○が環境に与える影響を減らすには、どんな工夫ができる？ | 社会参加の考察・サステナビリティ |
    | ○○を通じて新しい友達ができたら、一緒にどんな活動をしてみたい？ | 協働的学び・多様性理解 |
