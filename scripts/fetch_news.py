#!/usr/bin/env python3
"""
fetch_news.py — World News API 用
"""
...
def main():
    ...
    stop_words  = load_json(STOP_FILE, [])[:20]   # ←長すぎ対策で 20 個まで
